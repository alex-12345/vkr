<template>
    <div ref="mainContainer" class="image-uploader">
        <div class="image-uploader__input-wrapper">
            <img class="load" src="@/images/strelka.png">
        ...
        <button v-show="(!isEmpty || isLoading) && allowClear" @click="clearValue()" class="image-loader__clear-icon" title="Clear image">
...
<script lang="babel">
    import { App } from '@/views/Authenticated/Chat/Settings/ImageUploader/app';
    import { FileHelper } from '@/views/Authenticated/Chat/Settings/ImageUploader/file-helper';
